...
<div
  class="{$isDyslexic
    ? 'font-opendyslexic'
    : 'font-poppins'} group relative block h-64 sm:h-80 lg:h-96"
>
  ...
  >
    ...
    >
      ...
      <h2
        class="{$isDyslexic
          ? 'font-opendyslexic sm:text-lg'
          : 'font-urbanist sm:text-2xl'} mt-4 text-xl font-bold "
      >
        {header}
      </h2>
    </div>
    ...
    >
      <h3
        class="{$isDyslexic
          ? 'font-opendyslexic mb-6'
          : 'font-urbanist mb-4'} text-xl font-bold sm:text-2xl"
      >
        {header}
      </h3>
