...
const quizFile = `data/kuis/${fileName.replace(".txt", "-quiz.json")}`;

document.getElementById("quiz-title").textContent = `Kuis untuk: ${fileName.replace(".txt", "")}`;
...
fetch(quizFile)
  ...
  .catch(() => {
    document.getElementById("quiz-container").innerHTML = "<p>Kuis tidak tersedia untuk cerita ini.</p>";
  });
